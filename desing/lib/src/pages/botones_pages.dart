    ...
    return SafeArea(
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text('Clase de transaccion', style: TextStyle(color:Colors.white, fontSize: 30.0, fontWeight: FontWeight.bold),),
            SizedBox(height: 10.0,),
            Text('Clase con columnas de transaciones, y barios botones en la app', style: TextStyle(color:Colors.white, fontSize: 18.0),)
          ],
        ),
      ),
    );
  ...
  Widget _botonesRedondeado(){
    return Table(
      children: [
        ...
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.lightBlueAccent, Icons.movie, 'Movie'),
            _crearBotonRedondeado(Colors.green, Icons.cloud, 'Grocery'),
          ]
        ),
        TableRow(
          children: [
            _crearBotonRedondeado(Colors.red, Icons.phone, 'Phone'),
